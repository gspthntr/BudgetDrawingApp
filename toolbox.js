...
function Toolbox() {
	...
	function addDropdownToolIcon(tool){
		let dropdown = createDiv();
		dropdown.class("dropdown");
		dropdown.parent("sidebar");
		...
		let shapes = ["Star", "Circle", "Triangle", "Square", "Penis"];
		shapes.forEach(shape => {
			let item = createDiv(shape);
		...
		// button.mousePressed(() => {
		// 	(menu.hasClass("active") && menu.removeClass("active"))
